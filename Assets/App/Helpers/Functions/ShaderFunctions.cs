...
{
	public class ShaderFunctions : Functions
	{
		...
		{
			ChangeSpriteOpacity(spriteRenderer, newOpacity, delayDefault, timeDefault, curveDefault);
		}
		...
		{
			ChangeOpacity(material, newOpacity, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		{
			ChangeOpacity(material, newOpacity, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeOpacity(targetRenderer.material, newOpacity, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		public void ChangeOpacity(Renderer targetRenderer, float newOpacity, float delay, float time,
			string shaderKey = "_Background")
		{
			ChangeOpacity(targetRenderer.material, newOpacity, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeColor(material, newColor, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		{
			ChangeColor(material, newColor, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeColor(targetRenderer.material, newColor, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		public void ChangeColor(Renderer targetRenderer, Color newColor, float delay, float time,
			string shaderKey = "_Background")
		{
			ChangeColor(targetRenderer.material, newColor, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeFloat(material, newFloat, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		{
			ChangeFloat(material, newFloat, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeFloat(targetRenderer.material, newFloat, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		public void ChangeFloat(Renderer targetRenderer, float newFloat, float delay, float time,
			string shaderKey = "_MainScale")
		{
			ChangeFloat(targetRenderer.material, newFloat, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeOffset(material, newOffset, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		{
			ChangeOffset(material, newOffset, delay, time, curveDefault, shaderKey);
		}
		...
		{
			ChangeOffset(targetRenderer.material, newOffset, delayDefault, timeDefault, curveDefault, shaderKey);
		}
		...
		public void ChangeOffset(Renderer targetRenderer, Vector2 newOffset, float delay, float time,
			string shaderKey = "_MainTex")
		{
			ChangeOffset(targetRenderer.material, newOffset, delay, time, curveDefault, shaderKey);
		}
